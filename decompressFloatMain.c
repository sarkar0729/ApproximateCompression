...
**                         decompressFloatApproximate.o bitUtils.o bucket.o uint8.o
...
float *p_float;
	...
	printf("Uncompression successful, wrote %d floating point numbers to the file %s\n", elem_count, argv[2]);
